...
const NotFound = async () => (
  // const icon = await loadIcon('carbon:unknown');

  <div className="flex flex-col items-center text-center">
    {/* <Icon icon="carbon:unknown" className="h-44 w-44 text-white" ssr={true} /> */}
    {/* <Icon icon={icon} className="h-44 w-44 text-white" ssr={true} /> */}
